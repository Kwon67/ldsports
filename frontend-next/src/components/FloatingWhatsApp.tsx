...
export default function FloatingWhatsApp() {
  ...
  return (
    <button
      ...
      className="w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20BA5C] flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
      style={{
        position: 'fixed',
        bottom: '24px',
        left: '24px',
